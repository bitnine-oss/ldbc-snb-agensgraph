...
create index on ldbc.hasCreatorComment (start, "end", id);
...
create index on ldbc.isLocatedInOrgan (start, "end", id);
create index on ldbc.isLocatedInPost (start, "end", id);
create index on ldbc.isLocatedInComment (start, "end", id);
create index on ldbc.isLocatedInPerson (start, "end", id);
...
create index on ldbc.replyOfPost (start, "end", id);
create index on ldbc.replyOfComment (start, "end", id);
...
create index on ldbc.hasCreatorPost ("end", start, id);
create index on ldbc.hasCreatorComment ("end", start, id);
...
create index on ldbc.isLocatedInOrgan ("end", start, id);
create index on ldbc.isLocatedInPost ("end", start, id);
create index on ldbc.isLocatedInComment ("end", start, id);
create index on ldbc.isLocatedInPerson ("end", start, id);
...
create index on ldbc.replyOfPost ("end", start, id);
create index on ldbc.replyOfComment ("end", start, id);
